                        ...
                        <div class="card-body">
                            ...
                            <div class="row form-group">
                                <div class="col-md-6 mb-3 mb-md-0">
                                    ...
                                    <input type="text" id="fname" class="form-control" name="camp_phone" value="{{ $data->camp_phone }}">
                                </div>
                                <div class="col-md-6">
                                    <label class="text-black" for="lname">Kamp Telefonu Tekrar</label>
                                    <input type="text" id="lname" class="form-control" name="camp_phone_validation" value="{{ $data->camp_phone }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="web_address" class="form-control" value="{{ $data->web_address }}">
                            </div>
                            <div class="form-group">
                                <label>Konum</label>
