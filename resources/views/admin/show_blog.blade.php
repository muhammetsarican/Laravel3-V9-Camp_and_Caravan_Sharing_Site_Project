    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12 col-md-6">
                <h2 class="mb-2 text-gray-800">Bloglar</h2>
            </div>
                    ...
                    <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
                        <div class="row">
                            <div class="col-sm-12 col-md-2">
                                <a href="{{ route('admin_add_blog') }}" class="btn btn-black--hover breadcrumb">Blog
                                    Ekle</a>
                            </div>
                                    ...
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
                                                ...
                                                style="width: auto;">Yazar Adı</th>
                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
                                                colspan="1" aria-label="Office: activate to sort column ascending"
                                                style="width: auto;">Kategori</th>
                                            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($datalist as $dl)
                                            <tr class="odd">
                                                ...
                                                <td>{{ $dl->camp->name }}</td>
                                                <td>{{ $dl->status }}</td>
                                                <td><a href="{{ route('admin_edit_blog', ['id' => $dl->id]) }}"
                                                ...
                                                <td><a href="{{ route('admin_delete_blog', ['id' => $dl->id]) }}"
