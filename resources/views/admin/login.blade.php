        ...
        <section class="probootstrap_section" id="section-city-guides">
            <div class="container">
              <div class="row text-center mb-5 probootstrap-animate">
                <div class="col-md-12">
                  <h2 class="display-4 probootstrap-section-heading">Kamp & Karavan<br>Admin Oturum Sayfası</h2>
                </div>
              </div>
<div class="row">
    <div class="col-md-4 probootstrap-animate fadeInUp probootstrap-animated">
        <div class="row text-center mb-5 probootstrap-animate">
        <div class="col-md-12">
            <h4 class="border-bottom probootstrap-section-heading">Oturum Sayfası</h4>
          </div>
        </div>
      <div class="row">
        <div class="col-md-12">
    ...
    <form action="{{route('admin_logincheck') }}" method="post" enctype="multipart/form-data"  class="probootstrap-form probootstrap-form-box mb60">
        @csrf
        {{-- <div class="row mb-3">
          <div class="col-md-6">
          ...
          <div class="col-md-6">
            <div class="form-group">
              <label for="lname" class="sr-only sr-only-focusable">Soyad</label>
              <input type="text" class="form-control" id="lname" name="lname" placeholder="Soyad">
            </div>
          </div>
        </div> --}}
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <a href="{{route('user_register')}}">Kayıt Ol</a><br><br>    
          <input type="submit" class="btn btn-primary" id="submit" name="submit" value="Oturum Aç">
        </div>
      </form>
    </div>
  </div>
