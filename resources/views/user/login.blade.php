        ...
        <section class="probootstrap_section" id="section-city-guides">
            <div class="container">
              <div class="row text-center mb-5 probootstrap-animate">
                <div class="col-md-12">
                  <h2 class="display-4 probootstrap-section-heading">Kamp & Karavan 'a Hoşgeldiniz</h2>
                </div>
              </div>
<div class="row">
    ...
    <div class="col-md-8 probootstrap-animate fadeInUp probootstrap-animated">
      <form action="{{route('login') }}" method="post" enctype="multipart/form-data"  class="probootstrap-form probootstrap-form-box mb60">
        @csrf
        {{-- <div class="row mb-3">
          <div class="col-md-6">
