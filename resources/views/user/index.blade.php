                    ...
                    <div class="mother">
                        <div class="alt-menu alt-2">
                            @foreach ($parentCategories as $rs)
                                ...
                                <label for="acilirmenu2">{{ $rs->title }}</label><input type="checkbox" id="acilirmenu2"></label>
                                @if (count($rs->children))
                                    <div id="menum2">
                                        @include('user.category_tree_filter', [
                        ...
                        {{-- <div class="alt-menu alt-2">
                            <label for="acilirmenu2">Buraya Tıkla</label><input type="checkbox" id="acilirmenu2" /></label>
                            <div id="menum2">Tester</div>
                        </div> --}}
                    </div>
                </div>
            ...
            <div class="row justify-content-center mb-5">
                <div class="col-md-12 text-center mb-5 probootstrap-animate">
                    ...
                    <blockquote class="">
                        ...
                        <p class="probootstrap-author">
                            <a href="https://probootstrap.com/" target="_blank">
                                <img src="{{ asset('user') }}/images/person_1.jpg"
