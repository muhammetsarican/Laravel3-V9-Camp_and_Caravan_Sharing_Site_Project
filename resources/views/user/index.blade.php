...
@section('content')
<section class="probootstrap-cover overflow-hidden relative"  style="background-image: url('{{asset('user')}}/images/bg_1.jpg');" data-stellar-background-ratio="0.5"  id="section-user">
    ...
    <section class="probootstrap_section" id="section-city-guides">
      <div class="container">
        ...
        <div class="row">
        <div class="col-md-4">
            <h5 class="display-5 probootstrap-section-heading">Filtreler</h5>
            <ul>
            <li><input type="checkbox" name="Filtre1">Bölge</li>
              <ul>
              <li><input type="checkbox" name="Filtre2">Şehir</li>
              <li><input type="checkbox" name="Filtre3">Kamp Tipi</li>
            </ul>
            <li><input type="checkbox" name="Filtre4">Konaklama İmkanı</li>
            <li><input type="checkbox" name="Filtre4">Minimum Konaklama Süresi</li>
            <li><input type="checkbox" name="Filtre4">Konum</li>
            <li><input type="checkbox" name="Filtre4">Plaj Tipi</li>
          </div>
          <div class="col-md-8 row">

          <div class="col-lg-4 col-md-6 probootstrap-animate mb-3">
            <a href="#" class="probootstrap-thumbnail">
              <img src="{{asset('user')}}/images/img_1.jpg" alt="Free Template by ProBootstrap.com" class="img-fluid">
          ...
          <div class="col-lg-4 col-md-6 probootstrap-animate mb-3">
            <a href="#" class="probootstrap-thumbnail">
              <img src="{{asset('user')}}/images/img_2.jpg" alt="Free Template by ProBootstrap.com" class="img-fluid">
              <h3>Road</h3>
            </a>
          </div>
          <div class="col-lg-4 col-md-6 probootstrap-animate mb-3">
            <a href="#" class="probootstrap-thumbnail">
              <img src="{{asset('user')}}/images/img_3.jpg" alt="Free Template by ProBootstrap.com" class="img-fluid">
              <h3>Australia</h3>
            </a>
          </div>
          <div class="col-lg-12 col-md-6 probootstrap-animate mb-3">
            <a href="#" class="probootstrap-thumbnail">
              <img src="{{asset('user')}}/images/img_4.jpg" alt="Free Template by ProBootstrap.com" class="img-fluid">
              <h3>Japan</h3>
            </a>
          </div>
    ...
    <section class="probootstrap-section-half d-md-flex" id="section-about">
      <div class="probootstrap-image probootstrap-animate" data-animate-effect="fadeIn" style="background-image: url({{asset('user')}}/images/img_2.jpg)"></div>
      <div class="probootstrap-text">
    ...
    <section class="probootstrap-section-half d-md-flex">
      <div class="probootstrap-image order-2 probootstrap-animate" data-animate-effect="fadeIn" style="background-image: url({{asset('user')}}/images/img_3.jpg)"></div>
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="media probootstrap-media d-flex align-items-stretch mb-4 probootstrap-animate">
              <div class="probootstrap-media-image" style="background-image: url({{asset('user')}}/images/img_1.jpg)">
              </div>
            ...
            <div class="media probootstrap-media d-flex align-items-stretch mb-4 probootstrap-animate">
              <div class="probootstrap-media-image" style="background-image: url({{asset('user')}}/images/img_2.jpg)">
              </div>
              <div class="media-body">
          ...
          <div class="col-md-6">
            ...
            <div class="media probootstrap-media d-flex align-items-stretch mb-4 probootstrap-animate">
              <div class="probootstrap-media-image" style="background-image: url({{asset('user')}}/images/img_4.jpg)">
              </div>
              <div class="media-body">
            ...
            <div class="media probootstrap-media d-flex align-items-stretch mb-4 probootstrap-animate">
              <div class="probootstrap-media-image" style="background-image: url({{asset('user')}}/images/img_5.jpg)">
              </div>
              <div class="media-body">
            ...
            <div class="owl-carousel js-owl-carousel-2">
              <div>
                <div class="media probootstrap-media d-block align-items-stretch mb-4 probootstrap-animate">
                  <img src="{{asset('user')}}/images/sq_img_2.jpg" alt="Free Template by ProBootstrap" class="img-fluid">
                  <div class="media-body">
                    <h5 class="mb-3">02. Service Title Here</h5>
                    <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. </p>
                  </div>
              ...
              <div>
                <div class="media probootstrap-media d-block align-items-stretch mb-4 probootstrap-animate">
                  <img src="{{asset('user')}}/images/sq_img_1.jpg" alt="Free Template by ProBootstrap" class="img-fluid">
                  <div class="media-body">
                    <h5 class="mb-3">02. Service Title Here</h5>
                    <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. </p>
                  </div>
              ...
              <div>
                <div class="media probootstrap-media d-block align-items-stretch mb-4 probootstrap-animate">
                  <img src="{{asset('user')}}/images/sq_img_3.jpg" alt="Free Template by ProBootstrap" class="img-fluid">
                  <div class="media-body">
                    <h5 class="mb-3">02. Service Title Here</h5>
                    <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. </p>
                  </div>
              ...
              <div>
                <div class="media probootstrap-media d-block align-items-stretch mb-4 probootstrap-animate">
                  <img src="{{asset('user')}}/images/sq_img_4.jpg" alt="Free Template by ProBootstrap" class="img-fluid">
                  <div class="media-body">
                    <h5 class="mb-3">02. Service Title Here</h5>
                    <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. </p>
                  </div>
              ...
              <div>
                <div class="media probootstrap-media d-block align-items-stretch mb-4 probootstrap-animate">
                  <img src="{{asset('user')}}/images/sq_img_5.jpg" alt="Free Template by ProBootstrap" class="img-fluid">
                  <div class="media-body">
                    <h5 class="mb-3">02. Service Title Here</h5>
                    <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. </p>
                  </div>
