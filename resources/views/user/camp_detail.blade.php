        ...
        <div class="row">
            <div class="col-md-8">
                {{-- @foreach ($datalist as $dl)
                    <img src="{{ \Illuminate\Support\Facades\Storage::url($dl->image) }}" alt="{{ $dl->title }}"
                        ...
                        <div class="row probootstrap-animate">
                            <div class="col-md-12">
                                <div class="owl-carousel js-owl-carousel-3">
                                    <div>
                                        <div class="media probootstrap-media d-block align-items-stretch md-12 probootstrap-animate">
                                            <img src="{{ \Illuminate\Support\Facades\Storage::url($data->image) }}" alt="{{ $data->name }}"
                                            class="img-fluid" style="object-fit:cover; height:500px">
                                        </div>
                                    </div>
                                    @foreach($datalist as $dl)
                                    <div>
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-md-6 probootstrap-animate fadeInUp probootstrap-animated">
              <div class="row probootstrap-form probootstrap-form-box mb60 bg-light">
                
                <label class="text-primary ">Muhammet Sarıcan</label>
...
{{--                                    {{$avg}}--}}
{{--                                    @endforeach--}}
                <p class="text-black font-italic" style="height: auto">“Herşey çok güzel gidiyor”</p>
                    <p class="text-right text-danger">Site Güzel İlerliyo mu?</p>
                    <p class="text-left text-secondary font-italic" style="font-size: 12px">2022-06-02 18:07:05</p>
                <hr>
            ...
            <div class="col-md-6 probootstrap-animate fadeInUp probootstrap-animated">
              <form action="#" method="post" class="probootstrap-form probootstrap-form-box mb60 bg-light">
                <div class="form-group">
                ...
                <div class="form-group">
                  <label for="message" class="sr-only sr-only-focusable">Yorum</label>
                  <textarea cols="30" rows="10" class="form-control" id="message" name="message" placeholder="Yorumunuzu girin."></textarea>
                </div>
                <div class="form-group">
                  <input type="submit" class="btn btn-secondary" id="submit" name="submit" value="Yorum Yap">
                </div>
              </form>
            </div>
          </div>
